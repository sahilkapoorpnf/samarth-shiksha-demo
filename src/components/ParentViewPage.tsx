...
import { Heart, TrendingUp, BookOpen, Home, Star, Calendar, HeartPulse, MessageSquare, CheckCircle2, AlertTriangle, Brain } from "lucide-react";
...
const ParentViewPage = () => (
  <div className="space-y-6 pb-8">
    <div className="text-center">
      ...
      <p className="section-subtitle">Easy-to-understand progress reports and home activity suggestions for your child</p>
    </div>
        ...
        {milestones.map((m, i) => (
          <motion.div key={m.week} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.08 }}
            ...
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${
              m.status === "done" ? "bg-secondary text-secondary-foreground" : m.status === "current" ? "bg-primary text-primary-foreground animate-pulse-soft" : "bg-muted-foreground/20 text-muted-foreground"
